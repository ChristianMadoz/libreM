      ...
      <Card className="max-w-md w-full p-8 bg-white">
        ...
        <div className="space-y-4">
          <Button
            ...
            disabled={loading}
            className="w-full bg-white hover:bg-gray-50 text-gray-700 border border-gray-300 py-6 text-lg flex items-center justify-center gap-3"
          >
        ...
        <div className="mt-8 text-center">
          <button
            onClick={() => navigate('/')}
            className="text-[#3483FA] hover:underline font-medium"
          >
            Volver al inicio
          </button>
        </div>
